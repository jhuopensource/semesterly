...
from student.utils import get_student, get_yeet
from student.serializers import get_student_dict, get_yeet_dict
...
class FeatureFlowView(ValidateSubdomainMixin, APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        init_data = {
            ...
            'currentYeet': get_yeet_dict(self.yeet),
