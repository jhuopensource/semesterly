      ...
      >
        ...
        {modalHeader}
          <div className="modal-body">
            ...
            First Name: {this.props.userInfo.userFirstName}<br></br>
            Last Name: {this.props.userInfo.userLastName}<br></br>
            Graduating Class: {this.props.userInfo.class_year}<br></br>
            </div>
          </div>
        </div>
      </Modal>
